...
export const TRACKERS: Tracker[] = [
  ...
  },
  {
    ...
    notes: [
      ...
      { text: "Acompte 1 le 15/07, 55% du montant" },
      { text: "Acompte 2 le 15/12, 40% du montant" },
  ...
  },
  {
    ...
    notes: [
      ...
      { text: "Acompte 1 le 15/03" },
      { text: "Acompte 2 le 15/06" },
      { text: "Acompte 3 le 15/09" },
      { text: "Acompte 4 le 15/12" },
    ],
    types: ["IS_ACOMPTE"],
  ...
  },
  {
    ...
    title: "CVAE, acomptes",
    group: "autres",
    description: "Acomptes CVAE au 15/06 et 15/09.",
    icon: "💰",
    accent: "amber",
    notes: [
      { highlight: "Acompte si CVAE N-1 supérieure à 1 500 €", text: "" },
      { text: "Acompte 1 le 15/06, 50% du montant" },
      { text: "Acompte 2 le 15/09, 50% du montant" },
  ...
  },
  {
    ...
    title: "CVAE, solde",
    group: "autres",
    description: "Solde CVAE 1329-DEF au 18/05 N+1.",
    icon: "💰",
    accent: "amber",
    notes: [
    ...
    types: ["CVAE"],
    cols: (y) => [
      { key: `cvae-s-${y}`, label: "Solde CVAE", type: "CVAE", periode: `${y}` },
    ],
  },
  {
    slug: "tvs",
